...
class MoEAgentRunner:
    ...
    (`run(question: str, history=None) -> AgentResult`), different internal
    architecture — proves the platform is agent-agnostic with a second real,
    non-trivial agent, not just a trivial dummy swapped in for a test.
